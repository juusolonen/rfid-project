...
namespace Database.Migrations
{
    ...
    partial class RfidDatabaseContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventBaseDbEntityToolDbEntity", b =>
                {
                    b.Property<Guid>("TargetedEventsId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("ToolsId")
                        .HasColumnType("uuid");

                    b.HasKey("TargetedEventsId", "ToolsId");

                    b.HasIndex("ToolsId");

                    b.ToTable("EventBaseDbEntityToolDbEntity", (string)null);
                });
            ...
            modelBuilder.Entity("Database.Entities.EventBaseDbEntity", b =>
                {
                    b.HasOne("Database.Entities.UserDbEntity", "Caller")
                        .WithMany("CalledEvents")
                        .HasForeignKey("CallerId");

                    b.HasOne("Database.Entities.UserDbEntity", "TargetUser")
                        .WithMany("TargetedEvents")
            ...
            modelBuilder.Entity("EventBaseDbEntityToolDbEntity", b =>
                {
                    b.HasOne("Database.Entities.EventBaseDbEntity", null)
                        .WithMany()
                        .HasForeignKey("TargetedEventsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Database.Entities.ToolDbEntity", null)
                        .WithMany()
                    ...
                    b.OwnsOne("Database.Entities.ProcessedData", "ProcessedData", b1 =>
                        {
                            ...
                            b1.Property<string>("InitiatorName")
                                .HasColumnType("text");

                            b1.Property<string>("InitiatorSystemId")
                                .HasColumnType("text");

                            b1.Property<long?>("InitiatorTagEPC")
                                .HasColumnType("bigint");
                            ...
                            b1.PrimitiveCollection<List<string>>("TagNames")
                                .HasColumnType("text[]");
            ...
            modelBuilder.Entity("Database.Entities.UserDbEntity", b =>
                {
                    b.Navigation("CalledEvents");

                    b.Navigation("TargetedEvents");
                });
